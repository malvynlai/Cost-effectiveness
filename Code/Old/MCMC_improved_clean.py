...
def generate_transition_matrixAgeDistribution(transition_matrix, size, probDeath,ageDeath):
    ...
    for x in range(0, num_ages):
            matrix[0,ageDeath + x*size] = transition_matrix[0,ageDeath] + probDeath[x]    # increment death node
