...
def graphs(c_data, i_data):
    ...
    plt.legend()
    plt.grid()
    plt.savefig(rf'C:\Users\joannekl\Box\Cost-effectiveness\Verifications\Base Case Graphs\MASLD Transition Rates')
    plt.show()
    plt.close()
    ...
    for cur_state, percentages in c_percentages.items(): 
        ...
        plt.legend()
        plt.grid()
        plt.savefig(rf'C:\Users\joannekl\Box\Cost-effectiveness\Verifications\Base Case Graphs\{states[cur_state]} Transition Rates for Control')
        plt.show()
        plt.close()
    ...
    for cur_state, percentages in i_percentages.items(): 
        ...
        plt.legend()
        plt.grid()
        plt.savefig(rf'C:\Users\joannekl\Box\Cost-effectiveness\Verifications\Base Case Graphs\MASLD Transition Rates{states[cur_state]} Transition Rates for Intervention')
        plt.show()
        plt.close()
